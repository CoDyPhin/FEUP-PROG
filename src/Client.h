...
class Client{
 private:
  ...
  vector<string> strpackets; // vector to store client's packets in strings
 ...
 public:
  ...
  Client(string name, unsigned VATnumber, unsigned short familySize, Address address, vector<string> & packets, unsigned totalPurchased);
  // GET methods
  ...
  vector<string> getSTRPacketList() const;
  ...
  void setSTRPacketList(vector<string> & packets);
